...
subjects = [
    {"name": "VNP", "times_per_week": 2, "has_practical": True, "theoretical_duration": 3, "practical_duration": 2},
...
classrooms = [
    {"name": "Room A", "available_slots": ["Mon 9am", "Mon 10am", "Mon 11am", "Tue 2pm", "Tue 3pm", "Tue 4pm", "Wed 11am", "Wed 12pm", "Wed 1pm", "Thu 3pm", "Thu 4pm", "Thu 5pm", "Fri 10am", "Fri 11am", "Fri 12pm"]},
    {"name": "Room B", "available_slots": ["Mon 10am", "Mon 11am", "Mon 12pm", "Tue 1pm", "Tue 2pm", "Tue 3pm", "Wed 3pm", "Wed 4pm", "Wed 5pm", "Thu 9am", "Thu 10am", "Thu 11am", "Fri 11am", "Fri 12pm", "Fri 1pm"]}
]
        ...
        for _ in range(times_per_week):
            for classroom in state["classrooms"]:
                if classroom["available_slots"]:
                    lesson_type = "Practical" if subject["has_practical"] and _ >= subject["times_per_week"] else "Theoretical"
                    duration = subject["practical_duration"] if lesson_type == "Practical" else subject["theoretical_duration"]
                    ...
                    if len(available_slots) == duration:
                        ...
                        schedule.append({"subject": subject["name"], "classroom": classroom["name"], "slots": available_slots, "lesson_type": lesson_type})
                        break
